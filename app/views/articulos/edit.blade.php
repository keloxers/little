				...
				<!-- FORM SECTION : begin -->
											<section>
												<div class="container">
													...
													<!-- CONTACT FORM : begin -->
                            {{ Form::open(array('url' => URL::to('/articulos/' . $articulo->id), 'method' => 'PUT', 'class' => 'default-form')) }}
														...
														<div class="row">
															<div class="col-sm-4">
																...
																<div class="form-field">
																	...
																	{{ Form::text('articulo', $articulo->articulo, array('class' => 'm-required', 'id' => 'articulo', 'placeholder' => 'Ingrese el titular')) }}
																</div>
																<!-- NAME FIELD : end -->
																...
																<div class="form-field">
																	...
																	{{ Form::select('lang', array('en' => 'en', 'es' => 'es'), $articulo->lang, array('id' =>'lang')) }}
																</div>
																<!-- EMAIL FIELD : end -->
																...
																<div class="form-field">
																	...
																	{{ Form::select('tipo', array('principal' => 'Principal', 'secundaria' => 'Secundaria'), $articulo->tipo, array('id' =>'tipo')) }}
																</div>
																<!-- EMAIL FIELD : end -->
																...
																<div class="form-field">
																	...
																	{{ Form::select( 'categorias_id', Categoria::All()->
																			lists('categoria', 'id'), $articulo->categorias_id, array( "placeholder" => "")) }}
															...
															<div class="col-sm-8">
																...
																<div class="form-field">
																	...
																	{{ Form::textarea('copete', $articulo->copete, array('id' => 'copete', 'rows' => '12','placeholder' => 'Copete')) }}
																</div>
																<!-- MESSAGE FIELD : end -->
																...
																<div class="form-field">
																	...
																	{{ Form::textarea('texto', $articulo->texto, array('id' => 'texto', 'rows' => '12','placeholder' => 'Cuerpo')) }}
																</div>
																<!-- MESSAGE FIELD : end -->
